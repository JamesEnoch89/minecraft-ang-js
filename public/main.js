...
function createMinefield() {
  ...
  //seed mines, mine amount indicators
...
//call random mine function and place needed mine amount
...
// if only mines are left = win, otherwise game is not complete
...
function MinesweeperController($scope) {
  ...
  $scope.uncoverSpot = function(spot) {
    ...
    if(spot.content == "mine") { 
        $scope.hasLostMessageVisible = true; // YOU LOSE!
    } else { // new
        if(hasWon($scope.minefield)) { // check for win
